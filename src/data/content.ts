...
export const projects: Project[] = [
  ...
  },
  {
    ...
    techniques:
      "LLM-assisted semantic chunking into Chroma; OpenAI Agents SDK twin with RAG, email capture, and unknown-question tools; Gradio streaming chat UI hosted on Render.",
    result:
    ...
    bullets: [
      ...
      "Hosted the twin on Render and embedded a native portfolio chat widget (no OpenAI keys in the browser).",
    ],
  },
];
